...
const AddRoom = () => {
  ...
  return (
    <form className=" p-6 sm:p-8 max-w-3xl mx-auto">
      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        ...
        <div className='flex-1 max-w-48'>
          ...
          onChange={(e)=>({...inputs, roomType:e.target.value})}
        ...
        <div>
          ...
          className='border border-gray-300 mt-1 rounded-xl p-2 w-24'
...
<button
  type="submit"
  className="bg-primary text-white px-8 py-2 rounded-xl mt-8 
