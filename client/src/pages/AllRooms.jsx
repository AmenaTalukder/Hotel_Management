    ...
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-34 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div>
        ...
        {roomsDummyData.map(room => (
          <div
            key={room._id}
            className="flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:border-0 last:pb-0"
          >
            <img
              src={room.images[0]}
              alt="room"
            ...
            <div className="md:w-1/2 flex flex-col gap-2">
              ...
              <div className="flex gap-1 items-center text-gray-500 mt-2 text-sm">
      ...
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16">
        ...
        <div className={`flex items-center justify-between px-5 py-2.5 border-gray-300 ${openFilters && "border-b"}`}>
          ...
          <span
            ...
            className="hidden lg:block text-xs cursor-pointer text-gray-500 hover:text-gray-800"
          >
            CLEAR
          </span>
        </div>
