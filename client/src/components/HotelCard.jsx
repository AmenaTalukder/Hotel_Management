...
const HotelCard = ({room,index}) => {
  return (
    <Link to={`/rooms/${room._id}`} onClick={()=>scrollTo(0,0)} key={room._id} className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px 4px 4px rgba(0,0,0,0.05)]'>
        ...
        <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-1'>
             ...
             <div className='flex items-center justify-between mt-4'>
                ...
                <button className='px-4 py-2 text-sm font-medium border border-gray-400 rounded-xl hover:bg-gray-50
