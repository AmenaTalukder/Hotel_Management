  ...
  return (
    <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6 w-full">
        <input
          type="email"
          className="bg-white/10 px-4 py-2.5 border border-white/20 rounded-xl outline-none max-w-66 w-full"
          placeholder="Enter your email"
        />

        <button className="flex items-center justify-center gap-2 group bg-black px-4 md:px-7 py-2.5 rounded-xl active:scale-95 transition-all">
          Subscribe
          <img src={assets.arrowIcon} alt="arrow-Icon" className="w-3.5 invert gourp-hover:translate-x-1 transition-all" />
